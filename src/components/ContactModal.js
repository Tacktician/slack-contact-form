      ...
      >
        <div className='modal-container'>
          <div className='modal-text'>
            ...
            <h2>Our Pledge</h2>
            <p>
              In the interest of fostering an open and welcoming environment, we as contributors and community managers
            ...
            <p>
              Sauce Labs Community Team are the main organizers responsible for mediating challenging situations. We
              will always prioritize the ones who felt hurt to straighten the sense of safety and belonging, pursuing
              the well-being of individuals and communities. We acknowledge many of the issues every community deals
              with may rise from systemic issues and we will do our best seeking to create a more just and equitable
              society.
            </p>
            <p>
              Project maintainers have the right and responsibility to remove, edit, or reject posts, replies, code,
              links, and other contributions that are not aligned to this Code of Conduct, or to ban temporarily or
              permanently any contributor for other behaviors that they deem inappropriate, threatening, offensive, or
              harmful.
            </p>
            <p>
              The Sauce Labs Community Team may also appoint Community Moderators, empowered with some to all of these
              rights and responsibilities.
            </p>
            <h2>Scope</h2>
            <p>
              This Code of Conduct applies within all community spaces, and it also applies when an individual is
              representing the community in public spaces or attending community events. Examples of representing a
              project or community include using an official project email address, posting via an official social media
              account, or acting as an appointed representative at an online or offline event. Representation of the
              community may be further defined and clarified by the Sauce Labs Community Team.
            </p>
            ...
            <p>
              We are committed to investigating any reported violations of our code of conduct and taking appropriate
              steps to address the concerns of those affected, with a focus on prioritizing the needs of individuals who
              have experienced harm. If a member violates our code of conduct, we may consider a range of actions to
              address the situation, with a focus on supporting those who were harmed and repairing any damage done.
              Depending on the severity of the situation, we may need to take corrective actions, such as providing
              training, mediation, or in some cases, penalties such as temporary suspension or permanent expulsion from
              the community may be necessary to ensure the safety and well-being of all members.
            </p>
            <p></p>
            <h2>Attribution</h2>
            <p>
            ...
            <form onSubmit={handleSubmit}>
              ...
              <div className='submit-row'>
                <input
                  ...
                  required
                />
                <label htmlFor='agree-to-terms'>I agree to the terms of the code of conduct</label>
                <br />
                <br />
